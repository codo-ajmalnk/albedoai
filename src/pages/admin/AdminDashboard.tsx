...
import { BarChart3, MessageSquare, FileText, Users, TrendingUp, Clock } from 'lucide-react';
        ...
        {loading ? (
          ...
          <>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{mockMetrics.openTickets}</div>
                <p className="text-xs text-muted-foreground">
                  -8% from last week
                </p>
              </CardContent>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Documentation Articles</CardTitle>
                <FileText className="h-4 w-4 text-muted-foreground" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">{mockMetrics.totalArticles}</div>
                <p className="text-xs text-muted-foreground">
                  +5 new this week
                </p>
              </CardContent>
              ...
              {recentFeedback.map((item) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <span
                      className={`inline-flex items-center rounded-full px-2 py-1 text-xs font-medium text-white ${getStatusColor(item.status)}`}
                    >
        ...
        <Card>
          ...
          <CardContent>
            {loading ? (
              ...
              <div className="text-2xl font-bold">{mockMetrics.avgResponseTime}</div>
            )}
          </CardContent>
        </Card>
